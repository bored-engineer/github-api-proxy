...
| `--log-response-conn-reuse` | Log whether the upstream connection used for each request was freshly dialed or reused from the pool (`response.conn.remote.reused`, `was_idle`, `idle_time`) | `true` |
